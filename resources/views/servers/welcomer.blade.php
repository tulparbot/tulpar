    ...
    <div class="w-full flex space-x-2">
            ...
            <div class="bg-gray-800 shadow-lg rounded py-4 px-3">
                <form action="" method="post" class="space-y-5">
                    ...
                    <div>
                        ...
                        <input required type="text" id="text" name="text" placeholder="Welcome Text" value="Welcome"
        ...
        <div class="w-full lg:w-1/3">
            <a href="#" onclick="
                ...
                '{{ route('servers.welcomer.preview', $server) }}?time=' + Date.now().valueOf() +
            ...
            <div class="mt-2">
                <img id="preview" src="{{ route('servers.welcomer.preview', $server) }}" alt="Preview" class="w-full">
            </div>
        </div>
    </div>
</x-server-layout>
